            ...
            <div className="text-center py-10">
                ...
                <div className="md:flex max-w-5xl mx-auto gap-8 group">
                    <div className="bg-white/10 group-hover:blur-sm hover:!blur-none p-8 rounded-xl mix-blend-luminosity">
                        <img className="rounded-full h-20 mx-auto" src="/images/re1.JPG" alt="" />
                    ...
                    <div className="bg-white/10 group-hover:blur-sm hover:!blur-none p-8 rounded-xl mix-blend-luminosity">
                        <img className="rounded-full h-20 mx-auto" src="/images/re2.JPG" alt="" />
                    ...
                    <div className="bg-white/10 group-hover:blur-sm hover:!blur-none p-8 rounded-xl mix-blend-luminosity">
                        <img className="rounded-full h-20 mx-auto" src="/images/re3.JPG" alt="" />
